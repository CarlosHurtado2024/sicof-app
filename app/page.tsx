    ...
    <div className="font-[Inter,system-ui,sans-serif] bg-[#fafafa] text-slate-800 antialiased overflow-x-hidden selection:bg-slate-900/20 selection:text-slate-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-[72px]">
            ...
            <div className="md:hidden flex items-center">
              <button className="text-slate-600 hover:text-[#1B2A4A] focus:outline-none p-2 rounded-lg hover:bg-slate-100">
      ...
      <header className="relative pt-32 pb-24 lg:pt-44 lg:pb-36 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute bg-gradient-to-br from-slate-900/15 to-transparent w-[800px] h-[800px] rounded-full -top-40 -left-40 blur-3xl"></div>
          <div className="absolute bg-gradient-to-bl from-slate-400/10 to-transparent w-[600px] h-[600px] rounded-full top-20 right-0 blur-3xl"></div>
          <div className="absolute bg-gradient-to-t from-slate-400/10 to-transparent w-[500px] h-[500px] rounded-full bottom-0 left-1/3 blur-3xl"></div>
          {/* Dot pattern */}
          <div className="absolute inset-0 bg-[radial-gradient(#1B2A4A_0.8px,transparent_0.8px)] [background-size:32px_32px] opacity-[0.03]"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              {/* Badge */}
              <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-slate-100 text-[#1B2A4A] text-xs font-semibold border border-slate-300/60 gap-2">
                <span className="relative flex h-2 w-2">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-slate-500 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-[#1B2A4A]"></span>
                </span>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold tracking-tight text-slate-900 leading-[1.1]">
                Justicia familiar
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1B2A4A] via-[#2C4A7C] to-[#142035]">
                  inteligente y digital
                </span>
              </h1>

              <p className="text-base lg:text-lg text-slate-500 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Komi moderniza la gestión de las Comisarías de Familia con herramientas de IA, expediente digital y cumplimiento normativo automático de la Ley 2126.
              </p>

              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Link href="/login" className="group bg-[#1B2A4A] hover:bg-[#142035] text-white px-7 py-3.5 rounded-xl font-semibold transition-all shadow-xl shadow-slate-900/25 hover:shadow-2xl hover:shadow-slate-900/30 flex items-center justify-center gap-2 transform hover:-translate-y-0.5">
                  Empezar Ahora
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </Link>
                <button className="group bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 px-7 py-3.5 rounded-xl font-semibold transition-all flex items-center justify-center gap-2 hover:border-slate-400 hover:text-[#1B2A4A] shadow-sm">
                  <PlayCircle className="w-5 h-5 text-[#1B2A4A]" />
                  Ver Demo
                </button>
              </div>
              ...
              <div className="pt-4 flex items-center justify-center lg:justify-start gap-4 text-sm text-slate-400">
                <div className="flex -space-x-2.5">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-slate-500 to-slate-700 border-2 border-white flex items-center justify-center text-[10px] font-bold text-white shadow-sm">JD</div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1.5 font-medium">50+ entidades confían en Komi</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:h-[560px] flex items-center justify-center">
              <div className="relative w-full max-w-lg lg:max-w-full">
                ...
                <div className="absolute -right-4 top-12 bg-white p-4 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-slate-100 z-30 animate-[float_3s_ease-in-out_infinite_1s]">
                  <div className="flex items-center gap-3">
                    <div className="bg-slate-100 p-2.5 rounded-lg text-[#1B2A4A]">
                ...
                {/* Glow */}
                <div className="absolute inset-0 bg-gradient-to-b from-slate-900/10 to-transparent blur-[80px] -z-10 translate-y-20"></div>
              </div>
            </div>
      ...
      <section className="py-10 bg-white border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-3xl lg:text-4xl font-extrabold text-[#1B2A4A] mb-1 group-hover:scale-105 transition-transform">10,000+</div>
              <p className="text-slate-400 font-medium text-sm">Casos Gestionados</p>
            </div>
            <div className="group">
              <div className="text-3xl lg:text-4xl font-extrabold text-[#1B2A4A] mb-1 group-hover:scale-105 transition-transform">50+</div>
              <p className="text-slate-400 font-medium text-sm">Comisarías Activas</p>
            </div>
            <div className="group">
              <div className="text-3xl lg:text-4xl font-extrabold text-[#1B2A4A] mb-1 group-hover:scale-105 transition-transform">-40%</div>
              <p className="text-slate-400 font-medium text-sm">Tiempo de Respuesta</p>
            </div>
            <div className="group">
              <div className="text-3xl lg:text-4xl font-extrabold text-[#1B2A4A] mb-1 group-hover:scale-105 transition-transform">99.9%</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="md:col-span-2 md:row-span-2 bg-white rounded-2xl p-8 lg:p-10 shadow-sm hover:shadow-lg border border-slate-100 transition-all duration-300 group overflow-hidden relative">
              <div className="absolute top-0 right-0 w-80 h-80 bg-slate-100 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:bg-slate-200/60 transition-colors duration-500"></div>
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center text-[#1B2A4A] mb-6 group-hover:scale-110 group-hover:bg-slate-200 transition-all duration-300">
                ...
                <div className="mt-8 relative h-48 bg-gradient-to-br from-slate-50 to-slate-100/50 rounded-xl border border-slate-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-[#1B2A4A] to-[#0F1A2E] rounded-2xl p-6 lg:p-7 shadow-lg shadow-slate-900/20 text-white transition-all duration-300 group hover:-translate-y-0.5 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-200 text-sm mb-5 leading-relaxed">Algoritmos predictivos para valorar el nivel de riesgo en casos de violencia intrafamiliar.</p>
                <div className="w-full bg-white/15 rounded-full h-1.5">
                  <div className="bg-white h-1.5 rounded-full w-[75%]"></div>
                </div>
                <p className="text-slate-300 text-[11px] mt-2 font-medium">75% precisión en predicción</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4 group">
                  <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-[#1B2A4A] flex-shrink-0 group-hover:bg-slate-200 transition-colors">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-slate-100 to-slate-100 rounded-3xl p-8 lg:p-12 border border-slate-200/50">
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-center">
                    <p className="text-3xl font-extrabold text-[#1B2A4A] mb-1">99%</p>
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-slate-300/20 to-slate-300/20 blur-3xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="precios" className="py-24 relative bg-[#fafafa] border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            {/* Plan 2 - Popular */}
            <div className="bg-white rounded-2xl p-8 border-2 border-[#1B2A4A] shadow-[0_0_0_1px_rgba(124,58,237,0.1),0_20px_40px_rgba(124,58,237,0.12)] relative transform md:-translate-y-3">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#1B2A4A] text-white text-[11px] font-bold px-4 py-1 rounded-full tracking-wide shadow-lg shadow-slate-900/30">
                RECOMENDADO
              </div>
              <div className="mb-6">
              ...
              <button className="w-full py-3 px-4 bg-[#1B2A4A] text-white font-semibold rounded-xl hover:bg-[#142035] shadow-lg shadow-slate-900/25 hover:shadow-xl transition-all duration-300 mb-8 text-sm">
                Obtener Plan
              </button>
              <ul className="space-y-3 text-sm text-slate-500">
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-slate-800/10 rounded-full blur-[120px]"></div>
          <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-slate-700/10 rounded-full blur-[120px]"></div>
        </div>
        <div className="max-w-3xl mx-auto px-4 relative z-10 text-center">
          ...
          <cite className="flex items-center justify-center gap-4 not-italic">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-slate-500 to-slate-700 flex items-center justify-center text-white font-bold text-sm">
              MG
            </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-500 text-base mb-8 max-w-xl mx-auto">Comienza hoy y únete a más de 50 entidades que ya confían en Komi para proteger familias.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/login" className="group bg-[#1B2A4A] hover:bg-[#142035] text-white px-8 py-4 rounded-xl font-semibold transition-all shadow-xl shadow-slate-900/25 hover:shadow-2xl flex items-center justify-center gap-2 transform hover:-translate-y-0.5">
              Empezar Gratis
              <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <form className="flex flex-col gap-2">
                <input className="bg-slate-800 border border-slate-700 text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#1B2A4A] focus:border-transparent placeholder-slate-500 text-sm" placeholder="tu@email.com" type="email" />
                <button className="bg-[#1B2A4A] hover:bg-[#142035] text-white rounded-lg px-4 py-2.5 text-sm font-semibold transition-colors" type="button">Suscribirse</button>
              </form>
            </div>
