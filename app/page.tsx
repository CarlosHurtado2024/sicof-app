        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <FadeIn className="md:col-span-2 md:row-span-2" delay={0.1}>
              <div className="h-full bg-white rounded-2xl p-8 lg:p-10 shadow-sm hover:shadow-xl border border-slate-100 transition-all duration-500 group overflow-hidden relative">
            ...
            <FadeIn delay={0.2} fullWidth>
              <div className="h-full bg-white rounded-2xl p-6 lg:p-7 shadow-sm hover:shadow-lg border border-slate-100 transition-all duration-300 group hover:-translate-y-1">
            ...
            <FadeIn delay={0.3} fullWidth>
              <div className="h-full bg-gradient-to-br from-[#1B2A4A] to-[#0B1628] rounded-2xl p-6 lg:p-7 shadow-xl text-white transition-all duration-300 group hover:-translate-y-1 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            <FadeIn delay={0.1} fullWidth>
              <div className="h-full bg-white rounded-2xl p-8 border border-slate-200/60 hover:border-slate-300 transition-all duration-300 hover:shadow-lg group">
                <div className="mb-6">
            ...
            {/* Plan 2 - Popular */}
            <FadeIn delay={0.2} fullWidth>
              <div className="h-full bg-white rounded-2xl p-8 border-2 border-[#1B2A4A] shadow-[0_20px_60px_rgba(27,42,74,0.15)] relative transform md:-translate-y-3">
            ...
            {/* Plan 3 */}
            <FadeIn delay={0.3} fullWidth>
              <div className="h-full bg-white rounded-2xl p-8 border border-slate-200/60 hover:border-slate-300 transition-all duration-300 hover:shadow-lg">
                <div className="mb-6">
