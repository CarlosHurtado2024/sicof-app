...
export function RiskForm({ expedienteId, userRole }: RiskFormProps) {
    ...
    return (
        <Card className="w-full shadow-2xl shadow-slate-200/50 border-slate-200 rounded-3xl overflow-hidden bg-white">
            <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-8">
                ...
                <CardDescription className="flex items-center gap-3 mt-3">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Nivel de Riesgo Previsto:</span>
            ...
            <CardContent className="p-8 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4 p-6 bg-slate-50/50 border border-slate-100 rounded-2xl group hover:border-blue-200 transition-colors">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-start gap-3 p-2 rounded-xl hover:bg-white transition-colors">
                    ...
                    <div className="space-y-4 p-6 bg-slate-50/50 border border-slate-100 rounded-2xl group hover:border-amber-200 transition-colors">
                        <h3 className="font-black text-[10px] text-amber-600 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-4 p-6 bg-slate-50/50 border border-slate-100 rounded-2xl group hover:border-indigo-200 transition-colors">
                    ...
                    <div className="space-y-4 p-6 bg-slate-50/50 border border-slate-100 rounded-2xl group hover:border-emerald-200 transition-colors">
                        <h3 className="font-black text-[10px] text-emerald-600 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                ...
                <div className="space-y-3 p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                    <Label htmlFor="observaciones" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Análisis Profesional y Recomendaciones</Label>
                    <Textarea
                        id="observaciones"
                        value={observaciones}
                        onChange={(e) => setObservaciones(e.target.value)}
                        placeholder="Escriba aquí sus observaciones y sugerencias de medidas de protección..."
                        className="bg-white border-slate-200 min-h-[120px] rounded-xl focus:ring-2 focus:ring-blue-500/20"
                    />
                </div>
            </CardContent>
