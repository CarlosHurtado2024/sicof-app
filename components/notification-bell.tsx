                            ...
                            notifications.map((notif) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-start gap-3 px-5 py-3.5 text-left transition-colors hover:bg-slate-50 border-b border-slate-50 last:border-0 ${!notif.leida ? 'bg-slate-100/30' : ''
                                            }`}
                                    >
                                        {/* Icon */}
