...
export function ReceptionDashboard({ initialMinutas, kpis }: ReceptionDashboardProps) {
    ...
    return (
        <div className={`transition-colors duration-500 ${isCrisisMode ? 'bg-red-50/30 p-4 rounded-xl' : ''}`}>
            {/* Header */}
                ...
                <div className="flex items-center space-x-6">
                    ...
                    {!isCrisisMode && (
                        <Link href="/dashboard/recepcion/nuevo-caso">
                            <Button className="bg-[#7C3AED] hover:opacity-90 text-white px-8 py-3.5 rounded-xl font-semibold text-sm flex items-center shadow-lg shadow-[#7C3AED]/25 transition-all active:scale-95">
                    ...
                    <Button
                        ...
                        className={`transition-all duration-300 px-6 py-3.5 rounded-xl font-semibold ${isCrisisMode
            ...
            {!isCrisisMode && (
                <section className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 transition-all hover:shadow-md">
                        <div className="flex justify-between items-start mb-6">
                            <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.15em]">En Atención</p>
                        ...
                        <div className="flex items-baseline">
                            <h3 className="text-5xl font-bold text-slate-900 dark:text-white mr-3">{kpis.enAtencion}</h3>
                            <span className="text-sm text-slate-500 font-medium">personas</span>
                        </div>
                    </Card>

                    <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 transition-all hover:shadow-md">
                        <div className="flex justify-between items-start mb-6">
                            <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.15em]">Ingresos Hoy</p>
                            <Users className="h-5 w-5 text-slate-300 dark:text-slate-700" />
                        </div>
                        <div className="flex items-baseline">
                            <h3 className="text-5xl font-bold text-slate-900 dark:text-white mr-3">{kpis.totalHoy}</h3>
                        </div>
                    </Card>

                    <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 transition-all hover:shadow-md">
                        <div className="flex justify-between items-start mb-6">
                            <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.15em]">Radicados Hoy</p>
                            <FileText className="h-5 w-5 text-slate-300 dark:text-slate-700" />
                        </div>
                        <div className="flex items-baseline">
                            <h3 className="text-5xl font-bold text-slate-900 dark:text-white mr-3">{kpis.radicadosHoy}</h3>
                    ...
                    <Card className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 transition-all hover:shadow-md">
                        <div className="flex justify-between items-start mb-6">
                            <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-[0.15em]">Alertas Crisis</p>
                            <AlertTriangle className="h-5 w-5 text-slate-300 dark:text-slate-700" />
                        </div>
                        <div className="flex items-baseline">
                            <h3 className="text-5xl font-bold text-slate-900 dark:text-white mr-3">{kpis.crisisHoy}</h3>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col">
                        <div className="px-8 py-6 border-b border-slate-100 dark:border-slate-700">
                            <h4 className="text-lg font-bold text-slate-900 dark:text-white flex items-center">
                                <FileText className="mr-3 text-[#7C3AED] h-6 w-6" />
                ...
                <section className={`lg:col-span-8 ${isCrisisMode ? 'opacity-50 pointer-events-none filter grayscale' : ''}`}>
                    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden h-full flex flex-col">
                        <div className="px-8 py-6 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
                            <div>
                                <h4 className="text-lg font-bold text-slate-900 dark:text-white">Live Queue</h4>
                                <p className="text-[10px] text-[#7C3AED] font-bold uppercase tracking-[0.2em] mt-1">Actividad en Tiempo Real</p>
                            </div>
                            <div className="flex items-center space-x-3">
                                <div className="relative">
                                    <input
                                        className="pl-10 pr-4 py-2 text-sm bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-[#7C3AED]/20 w-64 transition-all"
