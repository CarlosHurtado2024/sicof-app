            ...
            <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <Button
                        onClick={atender}
                        variant="secondary"
                        className="flex-1 sm:flex-none font-bold text-red-300 bg-white/[0.02] backdrop-blur-xl hover:bg-red-500/100/10 border border-red-500/20 border-0 shadow-[0_0_30px_rgba(0,0,0,0.5)]"
                    >
                        🚨 Atender Emergencia
                    </Button>
                    <Button
